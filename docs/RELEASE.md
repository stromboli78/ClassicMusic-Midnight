# 0.9.0-beta.3 release checklist
...
- [ ] Tag `v0.9.0-beta.3`; GitHub Actions creates a prerelease and installable ZIP.
...
- [ ] Upload `ClassicMusic-Midnight-v0.9.0-beta.3.zip` as Beta with the matching changelog.
